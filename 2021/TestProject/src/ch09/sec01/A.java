...
public class A {
	...
	public class B {
		...
		// 필드 선언
		int field1; // 인스턴스 필드
		// static int field2; //static필드 선언 불가

		void method1() {System.out.println("B클래스의 method1() 실행");} // 인스턴스 메소드
		// static method2() {} //static메소드 정의 불가
	}
	...
	static class C {
		...
		//인스턴스 필드와 메소드, static필드와 메소드 선언 가능
		//필드
		int filed1;
		static int field2;
	...
	//A클래스의 멤버 메소드
	void method() {
		//로컬 클래스: 메소드 내에서 선언, 메소드 내에서 객체를 생성하고 사용해야 함
		 class D{
			 D(){System.out.println("객체 D생성!");}
			 //필드
			 int filed1;
			 //static int field2; //static필드 사용 불가
			 
			 //메소드
			 void method1() { System.out.println("D클래스의 method1()실행");}
			 //static void method2() {} //static메소드 정의 불가
		 }
